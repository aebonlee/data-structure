          ...
          <div className="lesson-body">
            ...
            <section className="lesson-section" data-aos="fade-up">
              ...
              <div className="callout-box" data-aos="fade-up">
                <strong>분할 정복의 핵심:</strong> 문제를 반으로 나누면 깊이가 log n이 되고,
                각 깊이에서 n개의 요소를 처리하므로 전체 시간 복잡도가 O(n log n)이 됩니다.
                이것이 O(n²) 정렬 알고리즘보다 훨씬 빠른 이유입니다.
              </div>
            </section>
...
결과: [3, 9, 27, 38, 43, 82]`}</code></pre>
            ...
            <section className="lesson-section" data-aos="fade-up">
              ...
              <div className="callout-box" data-aos="fade-up">
                <strong>O(n²) vs O(n log n) 차이:</strong> 데이터 100만 개를 정렬할 때,
                O(n²) = 1,000,000,000,000(1조) 연산 vs O(n log n) = 약 20,000,000(2천만) 연산.
                약 50,000배의 차이가 납니다!
              </div>
            </section>
            ...
            <section className="lesson-section" data-aos="fade-up">
              ...
              <div className="callout-box" data-aos="fade-up">
                <strong>병합 정렬 vs 퀵 정렬:</strong> 병합 정렬은 항상 O(n log n)을 보장하지만 O(n) 추가 메모리가 필요합니다.
                퀵 정렬은 제자리 정렬이지만 최악의 경우 O(n²)입니다.
                안정성과 성능 보장이 중요하면 병합 정렬, 평균 성능과 메모리가 중요하면 퀵 정렬을 선택합니다.
              </div>
            </section>
...
merge_sort_verbose([38, 27, 43, 3])`}</code></pre>
      ...
      <nav className="lesson-nav" data-aos="fade-up">
        <Link to="/algorithm/insertion-sort" className="lesson-nav-prev">
          <span className="lesson-nav-label">이전</span>
          <span className="lesson-nav-title">삽입 정렬</span>
        </Link>
        <Link to="/algorithm/quick-sort" className="lesson-nav-next">
          <span className="lesson-nav-label">다음</span>
          <span className="lesson-nav-title">퀵 정렬</span>
        </Link>
      </nav>
    </>
  );
