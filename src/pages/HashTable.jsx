          ...
          <div className="lesson-body">
            ...
            <section className="lesson-section" data-aos="fade-up">
              ...
              <div className="callout-box" data-aos="fade-up">
                <strong>핵심 아이디어:</strong> 키를 숫자(인덱스)로 변환하여 배열에 직접 접근하므로,
            ...
            <section className="lesson-section" data-aos="fade-up">
              ...
              <table className="lesson-table" data-aos="fade-up">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>균일 분포(Uniform Distribution)</td>
                    <td>출력값이 고르게 분포하여 충돌을 최소화</td>
                  </tr>
                  <tr>
                    <td>빠른 계산</td>
                    <td>해시값 계산이 O(1)에 가까워야 함</td>
                  </tr>
                  <tr>
                    <td>최소 충돌</td>
                    <td>서로 다른 키가 같은 인덱스에 매핑되는 경우를 최소화</td>
                  </tr>
                </tbody>
              </table>
              ...
              <table className="lesson-table" data-aos="fade-up">
                ...
                <tbody>
                  <tr>
                    <td>선형 탐사</td>
                    <td>(h + i) % size</td>
                    <td>간단하지만 클러스터링 발생</td>
                  </tr>
                  <tr>
                    <td>이차 탐사</td>
                    <td>(h + i<sup>2</sup>) % size</td>
                    <td>클러스터링 완화, 이차 클러스터링 가능</td>
                  </tr>
                  <tr>
                    <td>이중 해싱</td>
                    <td>(h + i * h2(key)) % size</td>
                    <td>가장 균일한 분포, 계산 비용 증가</td>
                  </tr>
                </tbody>
              </table>
              ...
              <table className="lesson-table" data-aos="fade-up">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>O(1)</td>
                    <td>O(n)</td>
                    <td>체이닝에서는 연결 리스트 탐색 필요</td>
                  </tr>
                </tbody>
              </table>

              <div className="callout-box" data-aos="fade-up">
                <strong>적재율(Load Factor):</strong> 저장된 데이터 수 / 버킷 배열 크기.
...
# hash([1, 2, 3])  # TypeError!`}</code></pre>
              ...
              <div className="callout-box" data-aos="fade-up">
                <strong>해시 가능(Hashable) 조건:</strong> Python에서 딕셔너리의 키가 되려면 불변(immutable)이어야 합니다.
      ...
      <nav className="lesson-nav" data-aos="fade-up">
        <Link to="/nonlinear/graph" className="lesson-nav-prev">
          <span className="lesson-nav-label">이전</span>
          <span className="lesson-nav-title">그래프</span>
        </Link>
        <Link to="/hash/hash-map" className="lesson-nav-next">
