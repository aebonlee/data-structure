            ...
            <section className="lesson-section" data-aos="fade-up">
              ...
              <table className="lesson-table" data-aos="fade-up">
                ...
                <tbody>
                  <tr>
                    <td>빈도 카운팅</td>
                    <td>각 요소의 등장 횟수를 기록</td>
                    <td>최빈값, 중복 검사</td>
                  </tr>
                  <tr>
                    <td>인덱스 매핑</td>
                    <td>값을 키로, 인덱스를 값으로 저장</td>
                    <td>두 수의 합 문제</td>
                  </tr>
                  <tr>
                    <td>그룹핑</td>
                    <td>공통 특성으로 데이터를 그룹화</td>
                    <td>애너그램 그룹핑</td>
                  </tr>
                  <tr>
                    <td>캐싱/메모이제이션</td>
                    <td>이전 계산 결과를 저장하여 재활용</td>
                    <td>피보나치, 동적 프로그래밍</td>
                  </tr>
                </tbody>
              </table>
...
print(two_sum(nums2, target2))  # [1, 2] (2 + 4 = 6)`}</code></pre>
              ...
              <div className="callout-box" data-aos="fade-up">
                <strong>브루트포스 vs 해시 맵:</strong> 이중 반복문으로 풀면 O(n<sup>2</sup>)이지만,
...
# [('r', 2), ('g', 2), ('m', 2)]`}</code></pre>
              ...
              <div className="callout-box" data-aos="fade-up">
                <strong>실전 팁:</strong> 코딩 테스트에서 빈도 카운팅이 필요하면 <code>Counter</code>를,
      ...
      <nav className="lesson-nav" data-aos="fade-up">
        <Link to="/hash/hash-table" className="lesson-nav-prev">
          <span className="lesson-nav-label">이전</span>
          <span className="lesson-nav-title">해시 테이블</span>
        </Link>
        <Link to="/algorithm/bubble-sort" className="lesson-nav-next">
