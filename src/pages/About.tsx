...
export default function About(): ReactElement {
  return (
    <>
      <SEOHead title="About | Data Structure" description="자료구조를 기초부터 고급까지 체계적으로 학습하는 교육 플랫폼" />
        ...
        <div className="container">
          ...
          <div style={{
            ...
            <strong style={{ fontSize: '17px', display: 'block', marginBottom: '12px' }}>
              이 사이트는 자료구조를 기초부터 고급까지 체계적으로 학습하는 교육 플랫폼입니다.
            </strong>
            <p style={{ margin: 0 }}>
              드림아이티비즈(DreamIT Biz)는 기업과 개인의 실제 니즈를 반영한 맞춤형 교육 플랫폼을 제작합니다.
              배열, 연결 리스트, 트리, 그래프 등 핵심 자료구조의 개념과 구현을 단계별로 학습할 수 있습니다.
            </p>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '20px', marginBottom: '48px' }}>
            {[
              { icon: 'fa-sitemap', title: '핵심 자료구조', desc: '배열, 스택, 큐, 트리, 그래프 등 핵심 자료구조를 학습합니다.' },
              { icon: 'fa-code', title: '구현 실습', desc: '각 자료구조를 직접 코드로 구현해봅니다.' },
              { icon: 'fa-chart-bar', title: '시간 복잡도', desc: '알고리즘의 효율성을 분석하는 방법을 배웁니다.' },
              { icon: 'fa-clipboard-check', title: '연습 문제', desc: '단계별 연습 문제로 이해도를 확인합니다.' },
            ].map((item, i) => (
              <div key={i} style={{
                display: 'flex',
                gap: '16px',
